    ...
    <>
      ...
      <section className=" bg-dark mt-20 pb-20 px-12">
        <div>
          ...
          <p className="text-sm lg:text-lg leading-8 text-light pt-4 text-center">
        ...
        <div className="flex flex-col gap-12 lg:gap-16 px-0 lg:px-10 mt-10 lg:flex-row">
          <div className="w-full lg:w-2/4">
            <span className="flex gap-2 justify-center items-center pb-4 ">
              ...
              <h2 className="text-light lg:text-xl text-lg font-bold">
                Progress
              </h2>
            </span>
            <p className="text-sm lg:text-lg leading-8 text-light">
